### NOTE: WHEN PLOTTING MANY TO MAKE MANY FILES IN A LOOP, USING THE
### PLAIN OLD AGG BACKEND SEEMS TO MAKE A HUGE DIFFERENCE WITH MEMORY
### ERRORS, WHERE THE COMP_CC_ OBJECT IS CALLED JUST INCLUDE:
### matplotlib.use('Agg')###
import os
import re
import math
